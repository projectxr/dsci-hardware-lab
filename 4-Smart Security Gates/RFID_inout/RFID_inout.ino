...
//***********Things to change*******************
const char* ssid = "Robospecies-4G";
const char* password = "robo@123";

String GOOGLE_SCRIPT_ID = "AKfycbwxO0fBf3gicQQaG-S1S1dFBgjj-hNdu4IztE4AAXLex5cAhLOaGFUwKKMdjgeaioByxQ"; // Replace by your GAS service id
const String unitName = "office"; // any name without spaces and special characters
//***********Things to change*******************
